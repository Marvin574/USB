 ...
 */
#pragma once
#include <EMAI-base/file.h>
#include <EMAI-base/properties.h>
#include <EMAI-base/unique_fd.h>
#include <EMAI/hardware/usb/gadget/1.1/IUsbGadget.h>
...
using ::EMAI::sp;
using ::EMAI::base::GetProperty;
using ::EMAI::base::SetProperty;
using ::EMAI::base::unique_fd;
using ::EMAI::base::WriteStringToFile;
...
using ::EMAI::hardware::usb::gadget::V1_0::GadgetFunction;
using ::EMAI::hardware::usb::gadget::V1_0::Status;
